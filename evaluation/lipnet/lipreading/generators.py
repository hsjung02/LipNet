    ...
    def enumerate_videos(self, path):
        ...
        for video_path in glob.glob(path):
            try:
                ...
                continue
            if keras.backend.image_data_format() == 'channels_first' and video.data.shape != (self.img_c,self.frames_n,self.img_w,self.img_h):
                ...
                continue
            if keras.backend.image_data_format() != 'channels_first' and video.data.shape != (self.frames_n,self.img_w,self.img_h,self.img_c):
