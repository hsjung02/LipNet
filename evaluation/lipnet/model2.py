...
class LipNet(object):
    ...
    def build(self):
        ...
        #print('inputs=',[self.input_data, self.labels, self.input_length, self.label_length])
        #print('outputs=',self.loss_out)
    ...
    def test_function(self):
        ...
        return K.function(inputs=self.input_data, outputs=self.y_pred)