...
class LipNet(object):
    ...
    def build(self):
        ...
        self.maxp1 = MaxPool3D(pool_size=(1, 2, 2), strides=(1, 2, 2), name='max1')(self.conv1)
        ...
        self.maxp2 = MaxPool3D(pool_size=(1, 2, 2), strides=(1, 2, 2), name='max2')(self.conv2)
        ...
        self.maxp3 = MaxPool3D(pool_size=(1, 2, 2), strides=(1, 2, 2), name='max3')(self.conv3)
